        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="mr-4 text-zinc-950">
                ...
                <div>
                  ...
                  <p className="text-zinc">(555) 123-4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc">info@luxurycabinets.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc">123 Design Avenue</p>
                  <p className="text-zinc">New York, NY 10001</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="luxury-card p-8">
              <div className="mb-6">
                <label htmlFor="name" className="block text-zinc-950 font-light mb-2">Name</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div className="mb-6">
                <label htmlFor="email" className="block text-zinc-950 font-light mb-2">Email</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div className="mb-6">
                <label htmlFor="phone" className="block text-zinc-950 font-light mb-2">Phone</label>
                <input
                  type="tel"
                  id="phone"
                  name="phone"
              ...
              <div className="mb-6">
                <label htmlFor="message" className="block text-zinc-950 font-light mb-2">Message</label>
                <textarea
                  id="message"
                  name="message"
